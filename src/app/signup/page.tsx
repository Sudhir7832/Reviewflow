...
export default function SignupPage() {
  ...
  const handleMagicLinkSignup = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      setMessage({ type: "success", text: "Welcome! Check your email for the magic link to get started." });
    }
    setIsLoading(false);
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <Card className="w-full max-w-md shadow-2xl border-emerald-100 rounded-2xl overflow-hidden">
        ...
        <CardHeader className="space-y-2 pt-8">
          <CardTitle className="text-3xl font-bold tracking-tight text-center text-slate-900">Create an Account</CardTitle>
          <CardDescription className="text-center text-base">
            Start collecting 5-star Google reviews today
          </CardDescription>
        </CardHeader>
